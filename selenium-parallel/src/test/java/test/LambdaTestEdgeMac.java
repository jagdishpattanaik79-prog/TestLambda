...
public class LambdaTestEdgeMac extends BaseTest {

	@Test
	public void runEdgeScenario() throws InterruptedException {
...
// Continue with your test...
		...
		//wait.until(ExpectedConditions.titleIs("TestingWhiz Integration With LambdaTest"));
		...
		WebElement communityLink = wait.until(

			    ExpectedConditions.elementToBeClickable(By.linkText("Community")));
